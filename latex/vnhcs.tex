...
% End of Proof
    ...
    iff \(e\) is of relative degree \(\{2,\ldots,2\}\), which is true 
    iff \(\tau\) appears in each row of \(\ddot{e}\) on \(\Gamma\). 
    This is equivalent to requiring that the matrix \(H\) be full rank
    everywhere on the constraint manifold, proving the theorem.
\end{proof}
