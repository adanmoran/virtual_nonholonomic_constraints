...
Suppose one wishes to set a constraint that depends on both the configuration
and the velocity.
TODO: Why do we bother with Hamiltonian? Why can't we do virtual nonholonomic 
constraints in Lagrangian?
...
%---------- Hamiltonian VHCS ---------%
\subsection{Hamiltonian Virtual Holonomic Constraints}
