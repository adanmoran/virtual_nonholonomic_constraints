...
% TODO: Replace this with a description that the dynamics of (q,p) are the
% constrained dynamics, and that we are using a VNHC o f the form h = l -
% L(q,p). We will simplify notation by saying that l = L(q,p) to mean that we
% are stabilizing h = l - L = 0
