...
\begin{figure}
   \centering
   % TODO: Inser the image of the optimal controller in the (q,p) plane: it
   % should just be 4 coloured quadrants (no spiral) representing squatting and
   % standing
...
\begin{figure}
   ...
   %that is, show l(theta) vs theta on ]-pi,pi] and show underline{l} and
   %overline{l} 
