...
a person will squat when they are stopped at the peak of the swing arc, and
...
constraints which model human motion to increase the robot's momentum.
Finally, we will rigorously prove that these constraints inject energy. 
