...
a person will squat when they are stopped at the peak of their swing, and
...
forces a robot's actuators to track a function of
position rather than time \cite{vhcs_for_el_systems}.
Sadly, this will not help the swinging robot since one needs
...
Our goal throughout this thesis is to develop rigorous proof that virtual
