...
\textbf{Run a sim of a simplfied acrobot model of a human}
%/========== Experiments ==========/%
...
The leg actuator is a servo motor with a built-in PID controller, so we
can directly assign \(q_a = \arctan\left(I p_u\right)\).
