...
nonholonomic constraint), and the dynamics of the acrobot when the relation
holds gain energy on some set \(D\) in the sense of Definition
...
\textbf{TODO: move energy regulation theory from sims to here}
