...
observed that only relations which use the unactuated conjugate of momentum
have vector relative degree \(\{2,\ldots,2\}\).
However, this is not enough to guarantee the 

We now provide a computational characterization of regularity
