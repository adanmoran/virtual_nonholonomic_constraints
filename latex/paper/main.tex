...
\documentclass[journal,twoside,onecolumn,draftclsnofoot,web]{ieeecolor}
...
Since \(q_a\) is constrained to be a function of the unactuated phase variables,
...
The only real distinction between this section and their work is that we allow
for higher degrees of underactuation, and our constrained dynamics are explicit
functions of the Hamiltonian phase coordinates \((q_u,p_u)\).
...
faster rotation \((q_u,p_u) = (0, 0.23)\); here the supervisor dissipated energy.
...
constraints for underactuated mechanical systems with arbitrary degree of
underactuation.
...
We then performed simulations and physical experiments of this VNHC.
