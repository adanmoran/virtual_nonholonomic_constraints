...
\(\mathcal{R}(\rho)\) to complete the proof of Theorem
\ref{thm:acrobot-energy-stabilization}.
...
\begin{align}
    ...
    \theta &= \pm q_u
\end{align}
where \(r \in \, ]\sqrt{60m^2gl^3}, \rho[\) and \(\pm\) denotes
whether \(D=\mathcal{R}^+(\rho)\) or \(D=\mathcal{R}^-(\rho)\).
...
so there exists a common \(I_2(\rho)\) whereby the acrobot gains/loses
