...
\[
    ...
    .
\]
Despite the change in acrobot model, the level set \(E_\pi\) with energy 
\(E(\pi,0)\) remains the boundary between oscillations and rotations
for the nominal pendulum.
...
Recall that this marks the boundary between oscillations and rotations of the
nominal pendulum.
...
Figure \ref{fig:acrobot-osc-reg} shows  stabilizing an
...
described in Section \ref{sec:energy-reg}.
